// extension.js — базове автодоповнення для .arx-файлів: ключові слова,
...
// Продубльовано з src/ArxLang/Compiler/Compiler.cs _builtins.
const BUILTINS = [
...
// Ідентифікатор в ArxLang може бути кирилицею (напр. "func подвоїти(x)"),
...
function keywordItems() {
    return KEYWORDS.map((kw) => {
        ...
        item.detail = 'ключове слово ArxLang';
        return item;
    });
}
...
function builtinItems() {
    return BUILTINS.map((name) => {
        ...
        item.detail = 'вбудована функція ArxLang';
