...
public sealed class ArxWebSocket : IDisposable
{
    public ClientWebSocket Socket { get; }
    public ArxWebSocket(ClientWebSocket socket) => Socket = socket;
...
public static class WebSocketModule
{
    ...
    private static object? WsConnect(object[] args)
    {
        ...
        return new ArxWebSocket(socket);
    }

    private static object? WsSend(object[] args)
    {
        var ws = (ArxWebSocket)args[0];
    ...
    // назавжди": викликач (напр. lib/discord.arx) сам мусить регулярно
