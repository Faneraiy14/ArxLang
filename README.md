...
машина та стандартна бібліотека з 78 вбудованих функцій — від математики й
...
мапи, JSON, файли, час, HTTP-запити, 2D-графіку на канвасі та зчитування
клавіш.
...
25 тестів: рекурсія, замикання, фрейми, мапи, методи, стандартна бібліотека,
...
відкидання дробової частини (`toInt`, індекси масивів). Графічні тести
пропускаються автоматично — вони відкривають вікна.
